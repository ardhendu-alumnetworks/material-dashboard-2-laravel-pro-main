<x-page-template bodyClass='g-sidenav-show bg-gray-200'>
    <x-auth.navbars.sidebar activePage='pages' activeItem='profile' activeSubitem='all-projects'>
    </x-auth.navbars.sidebar>
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        <!-- Navbar -->
        <x-auth.navbars.navs.auth pageTitle='All Projects'></x-auth.navbars.navs.auth>
        <!-- End Navbar -->
